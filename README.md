...
**Hello Rails** A small web app create with Ruby on Rails and React js which shows a radom greeting message.

## This is only the backend, the frontend is in [this repo](https://github.com/muhammedb8826/hello-react-front-end)
...
```bash
git clone https://github.com/muhammedb8826/hello-rails-back-end.git
```
